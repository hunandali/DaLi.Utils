...
#Region "属性"
		...
		Public Property DbName As String
			Get
				If _DbName.IsEmpty Then _DbName = VAR_DATABASE_CONNECTION_DEFAULT
				Return _DbName
			End Get
			Set(value As String)
				_DbName = value
...
#Region "初始化"
		...
		Public Sub SetContext(controller As CtrBase, Optional dbName As String = VAR_DATABASE_CONNECTION_DEFAULT)
		...
		''' <summary>设置操作请求对象</summary>
		Public Sub SetContext(appContext As IAppContext, controller As CtrBase, Optional dbName As String = VAR_DATABASE_CONNECTION_DEFAULT)
...
#Region "相关对象"
		...
		Public Shared Function GetSetting(Of T As ISetting)() As T
