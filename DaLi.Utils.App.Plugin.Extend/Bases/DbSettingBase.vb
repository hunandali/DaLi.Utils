...
Namespace Base
	...
	Public MustInherit Class DbSettingBase(Of T As {IDbSetting, New})
		...
		Private Const VAR_USER_AUTO = "AUTO"
		...
		Public Function Update(proName As String, value As Object, Optional user As String = VAR_USER_AUTO) As Boolean
