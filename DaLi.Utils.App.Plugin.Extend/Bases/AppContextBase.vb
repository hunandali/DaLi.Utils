...
Namespace Base
	...
	Public MustInherit Class AppContextBase
		...
		Public Function GetDb(Optional name As String = VAR_DATABASE_CONNECTION_DEFAULT) As IFreeSql Implements IAppContext.GetDb
		...
		Public ReadOnly Property Fields As KeyValueDictionary Implements IAppContext.Fields
			Get
				If _Fields Is Nothing Then
					...
					If Http.Request.Query.NotEmpty Then
						For Each Q In Http.Request.Query
							_Fields.Add(Q.Key, Q.Value)
						Next
					End If
				End If
