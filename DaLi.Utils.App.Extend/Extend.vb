...
Public Class Extend
	...
	Public Shared Sub Start(Optional systemApp As SystemExtend = Nothing, Optional args() As String = Nothing)
		...
		Call DaLi.Utils.App.Start(systemApp, args)
	End Sub

	Public Class SystemExtend
		Inherits App.SystemApp
	...
	Public Overrides Sub Initialize(app As ISystemBase)
		...
		dic.DictionaryExist(VAR_DICTIONARY_SYSTEM_KEY, Sub() dic.DictionaryInsert(0, VAR_DICTIONARY_SYSTEM_ID, "基础数据", -1, VAR_DICTIONARY_SYSTEM_KEY))
