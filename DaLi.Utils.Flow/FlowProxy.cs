...
namespace DaLi.Utils.Flow {
	...
	public class FlowProxy : FlowRuleBase {
		...
		protected override object Execute(SODictionary context, CancellationToken cancel) {
			...
			var ret = client.ExecuteApi<ExecuteStatus>(Http.Model.HttpMethodEnum.POST, "flow/rule", new { Rule = Rule.EncodeBase64(), context }.ToJson(false, false, false));
