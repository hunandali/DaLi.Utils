	...
	Public Class OnlyDictionary(Of TKey, TValue)
		...
		Default Public Property Item(key As TKey) As TValue
			Get
				...
				If key IsNot Nothing AndAlso Instance.TryGetValue(key, value) Then
					Return value
				Else
					Return Nothing
				End If
		...
		Public Sub Update(key As TKey, value As TValue, Optional force As Boolean = False)
			If key Is Nothing Then Return
		...
		''' <summary>更新数据，存在则将被覆盖，不存在则添加</summary>
