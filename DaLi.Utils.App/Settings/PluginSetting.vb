...
Namespace Setting
	...
	Public Class PluginSetting
		...
		Public Property RemoveAssembly As String()

		''' <summary>禁用插件列表，可以使用通配符 *，匹配 Types</summary>
		Public Property DisabledTypes As String()

		''' <summary>隐藏后台参数设置，可以使用通配符 *，匹配 ModuleName</summary>
		Public Property HideSettings As String()
