...
Namespace Attribute
	...
	Public NotInheritable Class FieldTypeAttribute
		...
		Protected Overrides Function IsValid(value As Object, validationContext As ValidationContext) As ValidationResult
			If value Is Nothing OrElse value.ToString.IsEmpty Then
				If EnNull Then
			...
			Select Case Type
				...
				Case FieldValidateEnum.UPPER_CASE
					Dim val = str.ToUpperInvariant
					If val = str Then Return ValidationResult.Success

				Case FieldValidateEnum.LOWER_CASE
					Dim val = str.ToLowerInvariant
					If val = str Then Return ValidationResult.Success
